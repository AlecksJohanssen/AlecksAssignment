...
public class SearchResultsListAdapter extends RecyclerView.Adapter<SearchResultsListAdapter.ViewHolder> {
    ...
    private List<DataWrapper> mDataSet = new ArrayList<>();

    private int mLastAnimatedItemPosition = -1;

    public interface OnItemClickListener{
        void onClick(DataWrapper colorWrapper);
    }
    ...
    public void swapData(List<DataWrapper> mNewDataSet) {
    ...
    public void onBindViewHolder(SearchResultsListAdapter.ViewHolder holder, final int position) {
        ...
        DataWrapper colorSuggestion = mDataSet.get(position);
